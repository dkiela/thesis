...
def simBrain(parameters):
	...
	# John
	n_j = bradb.LAYER({"TYPE":"NJ", "_UPPER":100, "_LOWER":67})
	n_j.AddCellType(ecell,1)
	col.AddLayerType(n_j)

	# Mary
	n_m = bradb.LAYER({"TYPE":"NM", "_UPPER":100, "_LOWER":67})
	n_m.AddCellType(ecell,1)
	col.AddLayerType(n_m)
	...
	n_j.AddConnect((ecell),(ecell), esyns,prob=parameters['CONN_INTERNAL'])
	n_m.AddConnect((ecell),(ecell), esyns,prob=parameters['CONN_INTERNAL'])
	...
	bradb.AddConnect((col,n_j,ecell),(col,n_x,ecell), esyns, prob=parameters['CONN_LATERAL'])
	bradb.AddConnect((col,n_x,ecell),(col,n_j,ecell), esyns, prob=parameters['CONN_LATERAL'])
	bradb.AddConnect((col,n_m,ecell),(col,n_x,ecell), esyns, prob=parameters['CONN_LATERAL'])
	bradb.AddConnect((col,n_x,ecell),(col,n_m,ecell), esyns, prob=parameters['CONN_LATERAL'])
	bradb.AddConnect((col,n_j,ecell),(col,n_y,ecell), esyns, prob=parameters['CONN_LATERAL'])
	bradb.AddConnect((col,n_y,ecell),(col,n_j,ecell), esyns, prob=parameters['CONN_LATERAL'])
	bradb.AddConnect((col,n_m,ecell),(col,n_y,ecell), esyns, prob=parameters['CONN_LATERAL'])
	bradb.AddConnect((col,n_y,ecell),(col,n_m,ecell), esyns, prob=parameters['CONN_LATERAL'])
	...
	# Connect to inhibit
	bradb.AddConnect((col,n_j,ecell),(col,n_i,icell), esyns, prob=parameters['CONN_LATERAL'])
	bradb.AddConnect((col,n_m,ecell),(col,n_i,icell), esyns, prob=parameters['CONN_LATERAL'])
	...
	bradb.AddConnect((col,n_i,icell),(col,n_j,ecell), isyns, prob=parameters['CONN_LATERAL'])
	bradb.AddConnect((col,n_i,icell),(col,n_m,ecell), isyns, prob=parameters['CONN_LATERAL'])
	...
	bradb.AddSimpleReport("JReport", (col,n_j,ecell), reptype="v", dur=d)
	bradb.AddSimpleReport("MReport", (col,n_m,ecell), reptype="v", dur=d)
