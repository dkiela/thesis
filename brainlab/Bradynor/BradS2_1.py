# -*- coding: utf-8 -*-
## Bradynor Simulation series 2 - experiment 1 - 21-02-2011
## Single Neuronal Memory
## Refs. Zirpe 2007, Vogels & Abbott 2005, Durstewitz
## MAJOR CHANGES FROM EXP SERIES 1: 1) Complex input added, 2) Final parameter set, 3) Added short-term dynamics and long-term plasticity (not used though)
## PURPOSE: This first simulation aimed at testing the stability of 1 single neuronal assembly.
## TEST: Assembly is stimulated initially for a limited interval 50 msec with an injected current.
## The network has to stably fire for at least 1 second after removal of the stimulus. 
...
# simulation
brainname="Brad_S2_1" 		# output files begin with this name
...
comp.parms['TAU_MEMBRANE']=['0.020,0.0']       #seconds
comp.parms['R_MEMBRANE']=['200,0.0']          # Membrane capacitance = 1 
comp.parms['LEAK_CONDUCTANCE']=['0.00005,0.0'] #seconds         
...
isyns.parms['MAX_CONDUCT']=['0.35'] #silent
#esyns.parms['MAX_CONDUCT']=['0.07'] #STABLE
#isyns.parms['MAX_CONDUCT']=['0.4']  #STABLE
...
#esyns.parms['MAX_CONDUCT']=['0.06']   #Stable SI
#isyns.parms['MAX_CONDUCT']=['0.4']    #Stable SI
...
exc1=bradb.LAYER({"TYPE":"E1", "_UPPER":90, "_LOWER":60})		# Excitatory layer
exc1.AddCellType(ecell,14)				

exc2=bradb.LAYER({"TYPE":"E2", "_UPPER":30, "_LOWER":10})		# Excitatory layer
exc2.AddCellType(ecell,1586)
#3186
#1593
inh=bradb.LAYER({"TYPE":"Inh", "_UPPER":60, "_LOWER":30})		        # Inhibitory layer
...
s.parms['AMP_END']='0.3'
s.parms['TIME_START']='0.001' #expressed in seconds
s.parms['TIME_END']='0.051'
s.parms['RATE']='25'
...
brainlab.ReportPlot(brainname, "E1Report",cols=[1,2,3],plottitle="E1e spikes", xlab="Timestep", ylab="mV", dosave=".png")
brainlab.ReportPlot(brainname, "E2Report",cols=[1,2,3],plottitle="E2e spikes", xlab="Timestep", ylab="mV", dosave=".png")
brainlab.ReportPlot(brainname, "IReport",cols=[1,2,3], plottitle="I spikes",xlab="Timestep", ylab="mV", dosave=".png")
