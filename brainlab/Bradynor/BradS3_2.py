# -*- coding: utf-8 -*-
## Bradynor Simulation series 3 - experiment 2 - 24-02-2011
...
## Note= version of the model with 1 column and 3 inhibitory pools. 1 for exc2, 1for exc3 and 1 for exc5
...
# simulation
brainname="BradS3-2" 		# output files begin with this name NB: Must be different froms script name or it will delete it!!!
...
esyns.parms['MAX_CONDUCT']=['0.06'] 
isyns.parms['MAX_CONDUCT']=['0.35'] 
...
bradb.AddSimpleReport("I3Report", (P,inh3,icell), reptype="v", dur=d)
...
s2.parms['TIME_START']='0.91'        # 50 ms stim injection
s2.parms['TIME_END']='0.96'
s2.parms['RATE']='20'
