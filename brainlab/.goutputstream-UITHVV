...
bradb.AddConnect((constants,c_bob,ecell),(variables,v_x,ecell),esyns, prob=0.02,speed=1)
...
stim_bob.parms['STIM_TYPE']=s1
stim_bob.parms['TYPE']='simple_inject1'
...
brainlab.ReportPlot(brainname, "BobReport",cols=[1],plottitle="John spikes", xlab="Timestep", ylab="mV", dosave=".png")
brainlab.ReportPlot(brainname, "XReport",cols=[1],plottitle="John spikes", xlab="Timestep", ylab="mV", dosave=".png")
