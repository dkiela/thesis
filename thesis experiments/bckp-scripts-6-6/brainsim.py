...
def simBrain(parameters):
	...
	bradb.AddConnect((col,n_x,ecell),(col,n_i,icell), esyns, prob=parameters['CONN_LATERAL'],speed=1)
	bradb.AddConnect((col,n_y,ecell),(col,n_i,icell), esyns, prob=parameters['CONN_LATERAL'],speed=1)
	bradb.AddConnect((col,n_i,icell),(col,n_x,ecell), isyns, prob=parameters['CONN_LATERAL'],speed=1)
	bradb.AddConnect((col,n_i,icell),(col,n_y,ecell), isyns, prob=parameters['CONN_LATERAL'],speed=1)
