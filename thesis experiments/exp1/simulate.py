...
def simulate(parameters):
	...
	n_x.AddConnect((ecell),(ecell), esyns,prob=0.02,speed=1)
	n_y.AddConnect((ecell),(ecell), esyns,prob=0.02,speed=1)

	bradb.AddConnect((col,n_x,ecell),(col,n_y,ecell), esyns, prob=0.02,speed=1)
	bradb.AddConnect((col,n_y,ecell),(col,n_x,ecell),esyns, prob=0.02,speed=1)
	...
	stimy.parms['TYPE']='simple_inject1'
